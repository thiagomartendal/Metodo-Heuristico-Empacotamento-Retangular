...
As instâncias de dados disponíveis na pasta instâncias são as utilizadas para obter os resultados dos experimentos, e as mesmas estão devidamente referênciadas no documento da dissertação.
