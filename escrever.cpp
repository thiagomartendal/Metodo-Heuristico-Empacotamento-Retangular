...
void Escrever::CSV(std::string pasta, std::string arquivo,
    long long int areaTotal, std::string tipoLucro, std::string instancia,
    double mediaTempoTotal, double mediaTempoMochila) {
    ...
    // csv.open(pastaCSV+'/'+arquivo+".csv", std::ios::out | std::ios::app);
...
void Escrever::TXT(std::string pasta, std::string arquivo,
    std::string tipoMochila, std::string tipoLucro, std::string instancia,
    std::vector<std::pair<int, std::vector<Item>>> conjuntos, Entrada entrada) {

    // Escreve os itens empacotados em um arquivo de texto
...
void Escrever::SVG(std::string pasta, std::string arquivo,
    std::string tipoMochila, std::string tipoLucro, std::string instancia,
    std::vector<std::pair<int, std::vector<Item>>> conjuntos, Entrada entrada) {

    // Produz imagens SVG dos empacotamentos
